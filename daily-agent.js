...
// Preset: pro-search | Response: output[].content[].text
...
const SEARCH_TOPICS = [
  ...
  { label: "Federal Contracts — Post-Inauguration Awards", query: "Which companies received no-bid or inflated federal contracts from the Trump administration after making donations?", issue_tags: ["trump-financial", "federal-contracts"] },
  ...
  { label: "Deregulation — Financial Industry", query: "Which banks or financial companies lobbied for Dodd-Frank, CFPB, or Basel rollbacks and benefited financially?", issue_tags: ["financial-deregulation", "lobbying"] },
  { label: "Deregulation — Energy & Environment", query: "Which oil, gas, or coal companies benefited from EPA or Clean Air Act rollbacks under Trump?", issue_tags: ["environment", "fossil-fuels", "lobbying"] },
  { label: "Deregulation — Food & Drug Safety", query: "Which food or pharma companies benefited from FDA or USDA safety regulation rollbacks under DOGE?", issue_tags: ["healthcare", "food-system", "lobbying"] },
  ...
  { label: "Medicare & Medicaid Cuts — Corporate Beneficiaries", query: "Which companies benefited from Social Security, Medicare, or Medicaid cuts or privatization?", issue_tags: ["healthcare", "wealth-extraction", "lobbying"] },
  { label: "Education Privatization — Voucher Profiteers", query: "Which companies profited from school voucher programs or education privatization?", issue_tags: ["education", "private-equity", "lobbying"] },
  ...
  { label: "Voting Suppression — Corporate Funders", query: "Which corporations funded voter suppression legislation, gerrymandering, or restrictive voting ID laws?", issue_tags: ["voting-rights", "civil-rights", "lobbying"] },
  ...
  { label: "Gun Lobby — NRA Corporate Funders", query: "Which companies fund the NRA or gun lobby and lobbied against gun control legislation?", issue_tags: ["lobbying", "trump-financial"] },
  { label: "ALEC — Model Legislation Corporate Funders", query: "Which companies fund ALEC or similar organizations that write model right-wing legislation?", issue_tags: ["lobbying", "legislation-support", "trump-financial"] },
  ...
  { label: "Private Equity — Housing Monopolization", query: "Which hedge funds or private equity firms bought single-family homes driving up rents?", issue_tags: ["private-equity", "wealth-extraction"] },
  { label: "Private Equity — Food System Monopolization", query: "Which private equity firms acquired food companies or grocery chains causing price increases?", issue_tags: ["food-system", "private-equity", "wealth-extraction"] },
  { label: "CEO Pay vs Worker Cuts", query: "Which companies increased CEO pay to record levels while laying off workers or cutting benefits?", issue_tags: ["labor", "wealth-extraction"] },
  ...
  { label: "Offshore Tax Havens", query: "Which U.S. companies use offshore tax havens to avoid U.S. taxes while benefiting from Republican tax bills?", issue_tags: ["tax-cuts", "wealth-extraction"] },
  { label: "Market Manipulation — Policy Trading", query: "Which company executives traded stocks ahead of Trump tariff or policy announcements?", issue_tags: ["market-manipulation", "trump-financial"] },
  { label: "Pharma — Price Gouging Post-Deregulation", query: "Which pharmaceutical companies raised drug prices after Medicaid cuts or deregulation?", issue_tags: ["healthcare", "price-gouging", "wealth-extraction"] },
  ...
  { label: "Junk Fees — CFPB Rollback Profiteers", query: "Which companies added or expanded junk fees after CFPB enforcement was gutted?", issue_tags: ["financial-deregulation", "wealth-extraction", "price-gouging"] },
  { label: "Gaza — Weapons & Munitions Suppliers", query: "Which U.S. companies supply weapons, bombs, or munitions to the Israeli military in Gaza?", issue_tags: ["gaza", "weapons"] },
  ...
  { label: "Gaza — Logistics & Supply Chain", query: "Which logistics or shipping companies support Israeli military supply chains in Gaza?", issue_tags: ["gaza", "weapons"] },
  ...
  { label: "Iran — War Escalation Profiteers", query: "Which defense companies profit from U.S. military buildup or escalation around Iran?", issue_tags: ["iran", "weapons"] },
  { label: "Congo & Sudan — Conflict Minerals", query: "Which companies source conflict minerals like coltan, cobalt, or lithium from Congo or Sudan?", issue_tags: ["congo", "sudan", "conflict-minerals"] },
  { label: "Yemen & Somalia — Arms Suppliers", query: "Which U.S. defense companies have weapons contracts tied to Yemen or Somalia conflicts?", issue_tags: ["weapons", "conflict"] },
  ...
  { label: "ICE — Private Detention Contractors", query: "Which private prison companies have ICE detention contracts and expanded under Trump deportation orders?", issue_tags: ["ice", "detention"] },
  ...
  { label: "ICE — Immigrant Labor Hypocrisy", query: "Which companies employ undocumented workers while supporting or donating to ICE enforcement?", issue_tags: ["ice", "labor"] },
  ...
  { label: "Border — Autonomous Surveillance Tech", query: "Which companies build or operate autonomous AI surveillance systems for CBP at the U.S. border?", issue_tags: ["surveillance-tech", "ice"] },
  { label: "Fossil Fuels — Federal Land Drilling", query: "Which oil and gas companies received drilling permits on newly opened federal lands under Trump?", issue_tags: ["environment", "fossil-fuels"] },
  ...
  { label: "Pollution — EPA Enforcement Rollback", query: "Which companies increased pollution or emissions after EPA enforcement was gutted by DOGE?", issue_tags: ["environment", "trump-financial"] },
  { label: "Media Capture — Editorial Suppression", query: "Which media companies softened editorial coverage of Trump or settled lawsuits under administration pressure?", issue_tags: ["media", "disinformation"] },
  ...
  { label: "Think Tanks — Dark Money Narratives", query: "Which think tanks or PR firms are paid by dark money to produce pro-Republican narratives?", issue_tags: ["disinformation", "lobbying"] },
...
async function searchTopic(topic, fromDate, toDate) {
  ...
  const inputText = `Search for real, documented corporate incidents between ${fromDate} and ${toDate}.
...
- Federal contracts post-inauguration (no-bid or after donations)
- Lobbying FOR: tax cuts for wealthy, deregulation, voter suppression, anti-labor, anti-abortion, anti-trans, gun lobby, Medicaid cuts, education privatization, ALEC model bills
- Lobbying AGAINST: minimum wage, worker protections, drug price controls, antitrust, financial regulation, climate action
- Benefiting from specific legislation passed due to their lobbying (name the bill)
- Tariff exemptions via lobbying, or price gouging using tariffs
- Private equity extracting from hospitals, housing, food, media
- CEO pay increases while laying off workers; stock buybacks over wages
- Weapons, tech, or logistics to Israel military in Gaza
- Arms to Yemen, Sudan, Congo, Somalia
- ICE detention contracts, enforcement tech, data sales to enforcement
- EPA rollback beneficiaries, climate denial funders
- Union busting, wage theft, OSHA violations
- Media editorial suppression
...
Each object must have ALL of these fields:
{
  ...
  "reason": "3-5 factual sentences with specific dollar amounts, bill names, contract values, dates.",
  "impact": 1-5,
...
Impact: 5=mass harm ($2M+ donation, weapons to conflict), 4=significant, 3=moderate, 2=indirect, 1=peripheral
If nothing credible found: []`;
  ...
  try {
    ...
    // Extract text from correct Agent API response format
    let text = '';
    ...
    // Fallback: iterate output array for message blocks
